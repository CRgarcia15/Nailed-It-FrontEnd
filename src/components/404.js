...
//fix the sizing of the image and the button
function Err () {
    ...
    return   (
        <div className="bg-zinc-300 w-screen h-screen">
            ...
            <div className="flex flex-col w-4/5 h-1/3 mx-auto mt-40 mr-40 mt-10">
                 ...
                 <a href="explore" className="ml-20 w-1/5 text-amber-700 text-center mt-5 bg-zinc-300 hover:bg-amber-700 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">Explore More</a>
            </div>
